...
from moatless.codeblocks import (
    CodeBlock,
    CodeBlockType,
    Relationship,
    ReferenceScope,
...
from moatless.module import Module
from moatless.parser.comment import get_comment_symbol
...
class CodeParser:
    ...
    def _build_queries(self, query_file: str):
        with resources.open_text("moatless.parser.queries", query_file) as file:
