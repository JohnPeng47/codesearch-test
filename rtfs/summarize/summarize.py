...
class Summarizer:
    ...
    async def summarize(self, test_run: bool = False):
    ...
    async def gen_categories(self, retries: int = 3):
        ...
        for cluster in [
            ...
            child_content = "\n".join(
                [
                    ...
                    if self._graph.get_node(c).kind
    ...
    def _clusters_to_yaml(self):
        clusters_json = self._graph.clusters_to_json()
